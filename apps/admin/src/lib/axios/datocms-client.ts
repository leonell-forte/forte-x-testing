...
const DATOCMS_TOKEN = import.meta.env.VITE_DATOCMS_TOKEN;
const DATOCMS_URL = import.meta.env.VITE_DATOCMS_API_URL;
const DATOCMS_ENV = import.meta.env.VITE_ENVIRONMENT;
