...
import CSV from "@/assets/images/icons/csv.svg?react";
import Excel from "@/assets/images/icons/excel.svg?react";
    ...
    <div className="w-full py-4">
      ...
      >
        ...
        <div className="space-y-2">
          {fileName ? (
            <>
              <p className="text-mint font-semibold">{fileName}</p>
            ...
            <>
              <p className="text-sm text-white">
                <span className="text-mint font-semibold underline">
                  Browse
                </span>{" "}
