      ...
      >
              ...
              filteredOptions.map((item, index) => {
                ...
                return isMultiSelect ? (
                  <button
                    key={index}
                    className={cn(
                      "checkbox gap ring-mint group flex max-w-full items-center overflow-hidden rounded-[8px] px-2.5 py-1.5 transition-all hover:bg-neutral-300 focus:ring-1",
                  ...
                  >
                    <li
                      className={cn(
                        "ring-mint list-none truncate rounded-[8px] p-2 text-sm text-black transition duration-500 focus:ring-1",
        ...
        {helperText && (
          <div className="absolute pl-4">
            <p
              className="text-alert line-clamp-1 text-[12px] font-medium"
              role="alert"
              aria-live="polite"
            >
              {helperText}
