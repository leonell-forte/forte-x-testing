        ...
        actions={[
          {
            ...
            icon: (
              <Update className="group-hover:fill-mint h-4 w-4 transition" />
            ),
          },
          {
            ...
            icon: (
              <Download className="group-hover:stroke-mint h-4 w-4 transition" />
            ),
          },
          {
            label: "Export CSV",
            ...
            icon: (
              <Export className="group-hover:stroke-mint h-4 w-4 transition" />
            ),
          },
        ]}
      />
