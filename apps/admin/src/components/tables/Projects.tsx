                  ...
                  <Table.Data>
                    <div className="flex justify-end gap-4 px-4">
                      {IsAuthorized([Projects.UPDATE]) && (
                        ...
                        >
                          <Pencil
                            className="group-hover:fill-mint group-focus:fill-mint h-auto w-5 transition-all"
                            aria-hidden="true"
                            role="presentation"
                          />
                      ...
                      {IsAuthorized([Projects.DELETE]) && (
                        ...
                        >
                          <Trash
                            className="group-hover:fill-mint group-focus:fill-mint h-auto w-4 transition-all"
                            aria-hidden="true"
                            role="presentation"
                          />{" "}
