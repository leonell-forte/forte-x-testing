...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "text-forest-green relative flex aspect-square h-16 w-16 items-center justify-center rounded-md bg-white bg-opacity-[50%] text-[24px] shadow-sm transition-all md:rounded-xl md:text-[40px]",
