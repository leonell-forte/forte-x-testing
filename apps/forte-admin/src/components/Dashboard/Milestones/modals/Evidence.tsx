...
import Loader from "@/assets/images/icons/loader.svg?react";
import ZoomIn from "@/assets/images/icons/zoom-in.svg?react";
import ZoomOut from "@/assets/images/icons/zoom-out.svg?react";
import Spinner from "@/components/ui/spinner/spinner";
import type { File } from "@/lib/types/common";
      ...
      {!loading && fileData ? (
        <div className="mx-auto flex flex-col items-center py-6">
          <div className="flex h-[calc(100vh-550px)] w-full max-w-[500px] items-center justify-center overflow-x-auto md:h-[calc(100vh-550px)]">
            ...
            {loading && (
              <>
                <Loader className="absolute w-10 animate-spin" />
