...
import type { EvidenceFieldValues } from "@/lib/types/evidence";
import type { IMilestone, TMilestoneEvidence } from "@/lib/types/milestones";
              ...
              <div className="flex flex-col items-center">
                ...
                {fileData && (
                  <div className="relative flex justify-center px-6 py-3 text-center">
                    <p className="text-mint pointer-events-none absolute truncate text-center font-semibold">
                      Replace document
                    </p>
