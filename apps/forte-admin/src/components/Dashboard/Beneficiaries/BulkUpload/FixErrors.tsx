...
import type { CsvData } from "@/pages/Beneficiaries/BulkUpload";
        ...
        <>
          {bannerOpen && (
            <>
              ...
              {errors.length === 0 && (
                <div
                  className={`bg-pastel-green mt-6 rounded-md border border-green-200 px-3 py-2 transition-all duration-300 ease-in-out ${
                    bannerOpen
                      ? "translate-y-0 opacity-100"
                      : "-translate-y-2 opacity-0"
                  }`}
          ...
          {showOnlyErrors && filteredRows.length === 0 ? (
            <div className="rounded-3 mt-4 flex min-h-[250px] items-center justify-center border text-center font-semibold">
                            ...
                            >
                              {hasRowErrors(originalIndex) ? (
                                <span className="font-bold text-red-500">
                                  {" "}
                                  <HiExclamationCircle className="fill-red h-auto w-8" />
                                </span>
                              ) : (
                                  ...
                                  >
                                    <div className="min-w-[150px]">
                                      {isEditing && columnOptions ? (
                                        <select
                                          className="rounded-3 w-full border border-white bg-transparent p-2.5 outline-none"
                                        ...
                                        <div
                                          className="hover:text-mint flex cursor-pointer items-center p-1 transition"
                                          onClick={() => {
                                            setEditingCell({
                                        ...
                                        >
                                          ...
                                          {error && (
                                            ...
                                            >
                                              <HiExclamationCircle className="stroke-red inline-block h-auto w-8 fill-white" />
                                            </div>
                                          )}
                                        </div>
                                      )}
