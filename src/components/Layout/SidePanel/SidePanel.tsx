...
const SidePanel = () => {
  ...
  return (
    <motion.div
      ...
      className="lg:max-h-auto fixed left-0 top-0 z-30 h-full max-h-screen w-[250px] rounded-r-lg border-transparent bg-panel p-5 backdrop-blur-md backdrop-brightness-[60%] lg:relative lg:h-auto lg:w-[172px] lg:rounded-lg lg:backdrop-blur-0 lg:backdrop-brightness-100"
    >
      <button
        onClick={handleClose}
