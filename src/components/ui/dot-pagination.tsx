  ...
  return (
    ...
    >
      {totalPages > 1 ? (
        ...
        >
          <button
            className="flex h-8 w-7 items-center justify-center text-white transition-colors hover:bg-[#1a2b32] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:cursor-not-allowed disabled:opacity-40"
